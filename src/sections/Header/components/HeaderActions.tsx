...
export const HeaderActions = () => {
  ...
  return (
    <div className="items-center box-border caret-transparent gap-x-2 flex grow justify-end min-h-[auto] outline-[3px] gap-y-2 ml-auto md:gap-x-4 md:gap-y-4">
      <div className="items-center box-border caret-transparent gap-x-2 flex grow min-h-[auto] outline-[3px] gap-y-2 md:gap-x-4 md:gap-y-4">
