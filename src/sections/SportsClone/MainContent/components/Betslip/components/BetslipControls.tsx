export const BetslipControls = () => {
  return (
    <div className="bg-white box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px]">
      <div className="box-border caret-transparent outline-[3px]">
        <form className="box-border caret-transparent gap-x-2 flex outline-[3px] gap-y-2 w-full mt-px mb-4">
          <div className="box-border caret-transparent basis-[0%] grow min-h-[auto] outline-[3px]">
          ...
          <button
            type="submit"
            className="relative appearance-none text-white items-center bg-green-600 caret-transparent flex h-11 min-h-[auto] opacity-50 outline-[3px] px-5 py-0 rounded-xl"
          >
