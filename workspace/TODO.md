...
Add a global auth context so logged-in state persists across components (show user avatar/balance in header after login).
</todo>

<todo id="form-validation">
Login form validation
Add real-time validation — required fields, phone format, min password length — with red error messages.
</todo>

<todo id="deposit-modal">
Deposit modal (from screenshot)
Build the Deposit popup (Fiat/Crypto tabs, BKash, Nagad, Upay, SurePay options) shown in the original screenshot.
</todo>
